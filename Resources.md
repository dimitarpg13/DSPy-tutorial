...
[DSPy Assertions: Computational Constraints for Self-Refining Model Language Pipelines, Arnav Singhvi et al, 2024](https://github.com/dimitarpg13/DSPy-tutorial/blob/main/docs/DSPy_Assertions-Computational_Constraints_for_Self-Refining_Language_Model_Pipelines_Singhvi_2024.pdf)
...
### Historical videos from Discover AI

[AI State Machines - State Agents - State Spaces explained, Discover AI, Jan 27, 2024 (youtube video)](https://youtu.be/_pyuxT8DXXU?si=nC8z7Hn37vZjGkUX)

[AI DSP: LLM Pipeline to Retriever Model (Stanford), Discover AI, Jan 29, 2024 (youtube video)](https://youtu.be/dTzL8OF_3i0?si=z7XcaCfI30iE_cce)

[DSPy explained: No more LangChain Prompt Templates, Discover AI, Jan 31, 2024 (youtube video)](https://youtu.be/ycfnKPxBMck?si=4a75U1xmJDgSrjly)

[DSPyG: DSPy combined w/ Graph Optimizer in PyG, Discover AI, Feb 4, 2024](https://youtu.be/rqR3LeR09gc?si=zuV66POeZpDPeaGy)

[Simple ideas to improve your RAG (Stanford, Google), Discover AI, Feb 7, 2024 (youtube video)](https://youtu.be/NePAPGxZnmE?si=A1AmVHOdg8q4uPgl)

[Topology DSPy: Prompting the Swarm (Multi-Agents), Discover AI, Feb 8, 2025](https://youtu.be/39ZUJsrazao?si=vFNW_6T0K2CvvtLH)
